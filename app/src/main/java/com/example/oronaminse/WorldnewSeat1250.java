...
public class WorldnewSeat1250 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.worldnewseat1250);

        back = (ImageButton) findViewById(R.id.WorldnewSeat1250Back);
        logout = (Button) findViewById(R.id.WorldnewSeat1250Logout);
        choice = (Button) findViewById(R.id.wor1250choice);
        A01 = (Button) findViewById(R.id.wor1250a01);
        A02 = (Button) findViewById(R.id.wor1250a02);
        A03 = (Button) findViewById(R.id.wor1250a03);
        A04 = (Button) findViewById(R.id.wor1250a04);
        A05 = (Button) findViewById(R.id.wor1250a05);
        A06 = (Button) findViewById(R.id.wor1250a06);


        back.setOnClickListener(new View.OnClickListener() { // /* (뒤로가기) 신세계 시간목록으로 이동
            @Override
