...
public class AvengersSeat1340 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.avengersseat1340);

        back = (ImageButton) findViewById(R.id.AvengersSeat1340Back);
        logout = (Button) findViewById(R.id.AvengersSeat1340Logout);
        choice = (Button) findViewById(R.id.ave1340choice);
        A01 = (Button) findViewById(R.id.ave1340a01);
        A02 = (Button) findViewById(R.id.ave1340a02);
        A03 = (Button) findViewById(R.id.ave1340a03);
        A04 = (Button) findViewById(R.id.ave1340a04);
        A05 = (Button) findViewById(R.id.ave1340a05);
        A06 = (Button) findViewById(R.id.ave1340a06);
