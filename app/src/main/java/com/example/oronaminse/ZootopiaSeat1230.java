...
public class ZootopiaSeat1230 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zootopiaseat1230);

        back = (ImageButton) findViewById(R.id.ZootopiaSeat1230Back);
        logout = (Button) findViewById(R.id.ZootopiaSeat1230Logout);
        choice = (Button) findViewById(R.id.zoo1230choice);
        A01 = (Button) findViewById(R.id.zoo1230a01);
        A02 = (Button) findViewById(R.id.zoo1230a02);
        A03 = (Button) findViewById(R.id.zoo1230a03);
        A04 = (Button) findViewById(R.id.zoo1230a04);
        A05 = (Button) findViewById(R.id.zoo1230a05);
        A06 = (Button) findViewById(R.id.zoo1230a06);
