...
public class WorldnewSeat1520 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.worldnewseat1520);

        back = (ImageButton) findViewById(R.id.WorldnewSeat1520Back);
        logout = (Button) findViewById(R.id.WorldnewSeat1520Logout);
        choice = (Button) findViewById(R.id.wor1520choice);
        A01 = (Button) findViewById(R.id.wor1520a01);
        A02 = (Button) findViewById(R.id.wor1520a02);
        A03 = (Button) findViewById(R.id.wor1520a03);
        A04 = (Button) findViewById(R.id.wor1520a04);
        A05 = (Button) findViewById(R.id.wor1520a05);
        A06 = (Button) findViewById(R.id.wor1520a06);
